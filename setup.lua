...
if arg[1] == "test" or arg[1] == "latest" then
    NIDAS = "https://github.com/AtomicGrog/NIDAS/releases/download/v-1/NIDAS.tar"
elseif arg[1] == "dev" or arg[1] == "staging" then
    NIDAS = "https://github.com/AtomicGrog/NIDAS/releases/download/v0/NIDAS.tar"
else
    NIDAS = "https://github.com/AtomicGrog/NIDAS/releases/latest/download/NIDAS.tar"
end
